...
# clastify.py: make clastification of emotion given input features (in npy files)
# dataset: JSET v1.1
...
x_train = np.load('./data/x_train_ti.npy')
y_train = np.load('./data/y_train_ti.npy')
...
acc_avg = []
# for SD with emolarge, smaller batch is better, i.e. 1024
for i in range(30):
